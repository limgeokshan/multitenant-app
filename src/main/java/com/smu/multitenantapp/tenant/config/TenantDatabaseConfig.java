...
import com.smu.multitenantapp.tenant.repository.UserRepository;
...
@ComponentScan(basePackages = { "com.smu.multitenantapp.tenant.repository",
        "com.smu.multitenantapp.tenant.entity" })
@EnableJpaRepositories(basePackages = {
        "com.smu.multitenantapp.tenant.repository",
        "com.smu.multitenantapp.tenant.service" }, 
...
public class TenantDatabaseConfig {
    ...
    public MultiTenantConnectionProvider multiTenantConnectionProvider() {
        ...
        return new DSMultiTenantConnectionProviderImpl();
    }
