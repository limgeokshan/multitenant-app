 ...
 */
package com.smu.multitenantapp.master.repository;
...
/**
 * Repository for the {@link Tenant} JPA entity. Any custom methods, not
...
public interface TenantRepository
     ...
     * @return
     */
    @Query("select p from Tenant p where p.tenantId = :tenantId")
