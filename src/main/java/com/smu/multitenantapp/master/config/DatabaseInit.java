 ...
 */
package com.smu.multitenantapp.master.config;
...
@EnableJpaRepositories(basePackages = { "com.smu.multitenantapp.master.entity",
        "com.smu.multitenantapp.master.repository" }, entityManagerFactoryRef = "masterEntityManagerFactory", transactionManagerRef = "masterTransactionManager")
public class DatabaseInit {
     ...
     */
    @Autowired
    private DatabaseProperties masterDbProperties;
